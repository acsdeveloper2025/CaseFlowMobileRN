...
const UntraceablePropertyIndividualForm: React.FC<UntraceablePropertyIndividualFormProps> = ({ caseData }) => {
  ...
  const validationConfig = useMemo(() => {
    return new ValidationConfigBuilder<UntraceablePropertyIndividualReportData>(
      MIN_IMAGES,
      [
    ...
    // String field validation for hold reason
    .addStringField('finalStatus', FinalStatusUntraceable.Hold, 'holdReason')
    .build();
  }, []);
