...
const NspPropertyIndividualForm: React.FC<NspPropertyIndividualFormProps> = ({ caseData }) => {
  ...
  const validationConfig = useMemo(() => {
    return new ValidationConfigBuilder<NspPropertyIndividualReportData>(
      MIN_IMAGES,
      [
    ...
    // When flat is opened, additional fields are required
    .addConditionalFields(
      'flatStatus',
      FlatStatusApf.Opened,
      ['metPerson', 'relationship', 'propertyOwnerName']
    )
