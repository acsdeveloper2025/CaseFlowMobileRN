...
const NspResidenceForm: React.FC<NspResidenceFormProps> = ({ caseData }) => {
  ...
  const validationConfig = useMemo(() => {
    return new ValidationConfigBuilder<NspResidenceReportData>(
      MIN_IMAGES,
      [
    ...
    .addStringField('houseStatus', HouseStatus.Closed, 'stayingPersonName')
    ...
    .addStringField('finalStatus', FinalStatusNsp.Hold, 'holdReason')
    .build();
  }, []);
