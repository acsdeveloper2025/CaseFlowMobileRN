...
const NspResiCumOfficeForm: React.FC<NspResiCumOfficeFormProps> = ({ caseData }) => {
  ...
  const validationConfig = useMemo(() => {
    return new ValidationConfigBuilder<NspResiCumOfficeReportData>(
      MIN_IMAGES,
      [
    ...
    // When office is open, additional fields are required
    ...
    .addStringField('resiCumOfficeStatus', ResiCumOfficeStatus.Closed, 'stayingPersonName')
