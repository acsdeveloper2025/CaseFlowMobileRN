...
const PositiveOfficeForm: React.FC<PositiveOfficeFormProps> = ({ caseData }) => {
  ...
  const validationConfig = useMemo(() => {
    return new ValidationConfigBuilder<PositiveOfficeReportData>(
      MIN_IMAGES,
      [
    ...
    .addStringField('applicantWorkingPremises', ApplicantWorkingPremisesOffice.DifferentLocation, 'sittingLocation')
